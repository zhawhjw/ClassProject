...
<?php
	...
	include( 'a_update_book_f.php' );	
?>



	<form action ="a_update_search_bar.php" name="a_update_search" method = "post" onsubmit="check(this); return false;">
		<div class = "title">
...
<?php
	...
	echo "p2</br>";
	admin_update_book($s_item,$keyword);
	$db->close();
?>
