<?php
	function admin_delete_book($ca, $kw){
...
?>
			...
			<tr>
				<form action ="do_delete.php" name="b_delete" method = "post">
				<td><input type="submit" value= "Delete"></td>
				<td><input type="hidden" name="b_id" value="<?php echo $field_id; ?>" ><?php echo $field_id; ?></td>
