...
<?php
	...
	include( 'c_purchase_book_f.php' );	
?>



	<form action ="c_purchase_search_bar.php" name="c_purchase_search" method = "post" onsubmit="check(this); return false;">
		<div class = "title">
...
<?php
	...
	echo "p2</br>";
	customer_purchase_book($s_item,$keyword);
	$db->close();
?>
